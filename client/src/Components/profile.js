          ...
          <div class="collapse" id="collapseExample1">
            <div class="updateCard">
              <input
                ...
                required
              />
              <button onClick={updateUserName} className="createACC-btn">
                Submit
              </button>
            </div>
          </div>
          ...
          <div class="collapse" id="collapseExample4">
            <div class="updateCard">
              <input
                ...
                required
              />
              <button onClick={updateUserId} className="createACC-btn">
                Submit
              </button>
            </div>
          </div>
        ...
        <div className="col-lg-4 beneficiariesUpdate fadeInRight">
          ...
          <div class="collapse" id="collapseExample7">
            <div class="updateCard">
              ...
              <button onClick={insertBenefeciary} className="createACC-btn">
                Submit
              </button>
            </div>
          </div>
