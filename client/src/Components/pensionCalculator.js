...
*/
  ...
  const performCalculation = () => {
    if (
      ...
      alert(
        "You must be currently above 18 years and retire at atleast 55 years of age!"
      );
    } else {
    }
  };
  ...
  if (potDepletion > 120) {
    result = (
      <span>
        You'll be on track to have <b>Ksh{TRP}</b> upon retirement. Taking{" "}
        <b>Ksh{DARI}</b> per year, will last you past <b>120 years of age</b>
      </span>
    );
  }
  if (potDepletion < 10) {
    result = (
      <span>
        You will only have <b>Ksh{TRP}</b> upon retirement. Taking{" "}
        <b>Ksh{DARI}</b> per year, will last you until age <b>{potDepletion}</b>
      </span>
    );
  }
  ...
  calculate = (
    <button className="calculatebtn" onClick={performCalculation}>
      Calculate
    </button>
  );
        ...
        <div className="row">
          ...
          <div className="col-lg-8 fadeInUp">
            ...
            <p className="text-center pCalculatorParagraph">
              Use our pension calculator to determine how much to contribute to
              your pension for an awesome retirement experience. Find out the
              potential duration of your pension and how contributions may
              affect your savings. 
            </p>
          </div>
          <div className="col-lg-2"></div>
          ...
          <div className="row">
            <div className="col-lg-4">
              <label for="cAge" className="inputLable">
                <span>
                  <b>
                    <span className="requiredField">*</span>Current Age:
                  </b>
                </span>
                <br />
                <input
              ...
              <label for="rAge" className="inputLable">
                <span>
                  <b>
                    <span className="requiredField">*</span>Retirement Age:
                  </b>
                </span>
                <br />
                <input
                  ...
                  className="inputbox pCalc"
                  id="rAge"
                  placeholder="Anticipated retirement age..."
                  required
                />
              </label>
            </div>
            <div className="col-lg-4">
              <label for="combinedPension" className="inputLable">
                ...
                <input
                  type="number"
                  onChange={onChange3}
                  name="combinedPension"
                  className="inputbox pCalc"
                  id="combinedPension"
                  placeholder="Current total combined pension..."
                />
              </label>
              <label for="monthlyContributions" className="inputLable">
                <span>
                  <b>Personal monthly contribution: </b>
                </span>
                <br />
                <input
                  type="number"
                  ...
                  placeholder="Anticipated monthly contributions..."
                />
              </label>
              <label for="retirementIncome" className="inputLable">
                <span>
                  <b>
                    <span className="requiredField">*</span>Desired annual
                    retirement income:
                  </b>
                </span>
                <br />
            ...
            <div className="col-lg-4">
              <label for="oneOffContribution" className="inputLable">
                <span>
                  <b>Personal One time contribution:</b>
                </span>
                <br />
                <input
                  type="number"
                  ...
                  placeholder="One-off contribution..."
                />
              </label>
              <label for="employerContributions" className="inputLable">
                <span>
                  <b>Monthly Employer contributions:</b>
                </span>
                <br />
                <input
                  type="number"
